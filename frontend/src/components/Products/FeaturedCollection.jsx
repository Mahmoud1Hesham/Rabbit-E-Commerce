        ...
        <section className="py-16 px-4">
            <div className="container mx-auto flex flex-col-reverse lg:flex-row items-center bg-green-100 rounded-3xl">
                ...
                <div className="lg:w-1/2 p-8 text-center lg:text-left">
                    ...
                    <Link 
                    to="/collections/all"
                    className='bg-black text-white px-6 py-3 rounded-lg text-lg-center hover:bg-gray-800'
                    >
                    Shop Now
                    </Link>
                </div>
                ...
                <div className="lg:w-1/2 p-8">
                    <img
                        ...
                        className="lg:rounded-tr-3xl lg:rounded-br-3xl object-cover w-full h-full"
                    />
                </div>
            </div>
        </section>
